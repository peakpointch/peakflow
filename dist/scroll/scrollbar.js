export function getVisibleScrollbarWidth(element) {
...
export function addScrollbarPadding(element, scrollbarElement) {
    if (!scrollbarElement)
...
export function removeScrollbarPadding(element) {
