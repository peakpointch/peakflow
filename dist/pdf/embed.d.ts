...
export declare class PdfEmbed extends BaseComponent<PdfEmbedElement, PdfEmbedSettings> {
    ...
    protected static readonly attributeSelector: import("../selector/selector.js").AttributeSelector<PdfEmbedElement>;
    static readonly selector: import("../selector/selector.js").InstanceSelector<PdfEmbedElement>;
    static readonly select: <U extends Element = HTMLElement>(this: unknown, element: PdfEmbedElement, instance?: string, options?: import("../selector/selector.js").SelectOptions) => U;
    static readonly selectAll: <U extends Element = HTMLElement>(this: unknown, element: PdfEmbedElement, instance?: string, options?: import("../selector/selector.js").SelectOptions) => NodeListOf<U>;
