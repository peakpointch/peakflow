...
export declare class PdfEmbed extends BaseComponent<PdfEmbedElement, PdfEmbedSettings> {
    ...
    static select: <U extends Element = HTMLElement>(element: PdfEmbedElement, instance?: string, options?: import("../selector/selector.js").SelectOptions) => U;
    static selectAll: <U extends Element = HTMLElement>(element: PdfEmbedElement, instance?: string, options?: import("../selector/selector.js").SelectOptions) => NodeListOf<U>;
