 ...
 */
export function softHyphenizer(container, language) {
    ...
    while ((node = walker.nextNode())) {
        ...
        if (parent &&
            ...
            !parent.matches(`[data-hyphenate="false"], [data-hyphenate="false"] *, [data-hyphenize="false"], [data-hyphenize="false"] *`) &&
            node.nodeValue?.trim()) {
 ...
 */
export function solidHyphens(container) {
    const walker = document.createTreeWalker(container, NodeFilter.SHOW_TEXT);
    const textNodes = [];
    let node;
    while ((node = walker.nextNode())) {
 ...
 */
export function doesWordBreak(referenceNode, prefixText, word) {
